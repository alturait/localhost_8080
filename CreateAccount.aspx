<%@ Page Title="Create Account" Language="VB" MasterPageFile="MasterPage.master" AutoEventWireup="false" CodeFile="CreateAccount.aspx.vb" Inherits="CreateAccount" %>
        ...
        <tr>
            <td class="pagebody" style="vertical-align: top">
                <table style="width: 100%">
                    ...
                    <tr>
                        <td colspan="3"><asp:Label ID="errormsglbl" runat="server" Text="The email you entered is already registered." Visible="False" ForeColor="Red"></asp:Label></td>
                    </tr>
                    <tr>
                        <td style="width: 15%">
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td>
                            <asp:TextBox ID="s_address3tb" runat="server" CssClass="address3tb" Width="300px"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
