<%@ Page Title="Edit Company" Language="VB" MasterPageFile="Admin.master" AutoEventWireup="false" CodeFile="Company.aspx.vb" Inherits="Company" %>
            ...
            <td class="est_pagebody" style="vertical-align: top">
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 35%">
                            <asp:DropDownList ID="repdd" runat="server" DataSourceID="SqlDFOUsers" DataTextField="name" DataValueField="userID">
                            </asp:DropDownList>
                        </td>
                        <td>
                            &nbsp;</td>
                    ...
                    <tr>
                        <td style="width: 15%">
                            <asp:Label ID="Label20" runat="server" CssClass="est_heading1" Text="CompanyID"></asp:Label>
                        </td>
                        <td style="width: 35%">
                            <asp:Label ID="companyIDlbl" runat="server" CssClass="est_heading1"></asp:Label>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td style="width: 15%">
                            <asp:Label ID="Label21" runat="server" CssClass="est_heading1" Text="Active"></asp:Label>
                        </td>
                        <td style="width: 35%">
                            <asp:CheckBox ID="activecb" runat="server" AutoPostBack="True" />
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="warehouselbl0" runat="server" CssClass="est_heading1" Text="Labor Rate"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="laborratetb" runat="server" CssClass="est_textbox1"></asp:TextBox>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <asp:Label ID="purchasinglbl0" runat="server" CssClass="est_heading1" Text="Send Kit Status"></asp:Label>
                            
                        </td>
                        <td>
                            
                            <asp:CheckBox ID="sendkitstatuscb" runat="server" />
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="3">
                            ...
                            <asp:Label ID="purchasinglbl2" runat="server" Text="NOTIFICATIONS" Font-Bold="True" Font-Size="Medium"></asp:Label>
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:Label ID="purchasinglbl1" runat="server" CssClass="est_heading1" Text="Equipment"></asp:Label>
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center">
                            ...
                            <asp:Button ID="deletebtn" runat="server" Text="Delete" CssClass="pushbutton1 gold" OnClientClick="return confirm('Delete this Customer?');" />
                        </td>
                        <td></td>
                    </tr>
                </table>
