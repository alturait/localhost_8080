...
Partial Class main_WebContacts
    ...
    Protected Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GridView1.RowCommand
        If e.CommandName = "Edit" Then
            ...
            Response.Redirect("WebContact.aspx")
        ElseIf e.CommandName = "Send" Then
            ...
            message &= "<p>Web Site: <a href='http://www.dfofilters.com'>www.dfofilters.com</a></p>"
            ...
            SendEmail(sentby, message, recipient, subject, "", "kgardner@dfofilters.com")
            Response.Redirect("WebContacts.aspx")
        End If
    End Sub
