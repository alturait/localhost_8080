<%@ Page Title="Shopping Cart" Language="VB" MasterPageFile="Admin.master" AutoEventWireup="false" CodeFile="Cart.aspx.vb" Inherits="Cart" %>
                        ...
                        <td style="vertical-align: top">                            
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Panel ID="Panel1" runat="server" DefaultButton="addbtn">
                                                        ...
                                                        <table style="width: 100%">
                                                            <tr>
                                                                <td style="width: 35%; text-align: left;">
                                                                    <a href='VCatalogPage.aspx?productID=<%# Eval("productID")%>'><asp:Label ID="partnumberlbl" runat="server" Text='<%# Bind("partnumber") %>'></asp:Label></a>
