<%@ Page Title="Part" Language="VB" MasterPageFile="Admin.master" AutoEventWireup="false" CodeFile="Part.aspx.vb" Inherits="Part" %>
                    ...
                    <tr>
                        <td style="width: 70%; vertical-align: top;">
                            ...
                            <asp:Label ID="otherlbl" runat="server" Font-Bold="True" Font-Size="Medium">Equipment that uses this part:</asp:Label>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlEquipment" GridLines="None" Width="50%">
                                            <Columns>
