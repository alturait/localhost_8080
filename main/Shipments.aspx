<%@ Page Title="Shipments" Language="VB" MasterPageFile="Admin.master" AutoEventWireup="false" CodeFile="Shipments.aspx.vb" Inherits="EST_Shipments" %>
...
<asp:SqlDataSource ID="SqlShipments" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [v_shipments] WHERE ([vendorID] = @vendorID) and shipped=@shipped ORDER BY [shipmentID]">
    <SelectParameters>
        <asp:SessionParameter Name="vendorID" SessionField="companyID" />
        <asp:Parameter DefaultValue="False" Name="shipped" />
    </SelectParameters>
</asp:SqlDataSource>
</asp:Content>
