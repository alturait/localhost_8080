<%@ Page Title="New Customer" Language="VB" MasterPageFile="Admin.master" AutoEventWireup="false" CodeFile="NewCustomer.aspx.vb" Inherits="NewCustomer" %>
                ...
                <table style="width: 100%">
                    <tr>
                        <td colspan="3" style="padding-bottom: 10px">
                            ...
                            <asp:Label ID="errormsglbl" runat="server" Text="The email you entered is already registered." Visible="False" ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 15%">
                    ...
                    <asp:Panel ID="Panel1" runat="server">
                        <tr>
                            <td style="width: 15%"><asp:Label ID="Label3" runat="server" CssClass="est_heading1" Text="Representative"></asp:Label></td>
                            <td style="width: 35%">
                                <asp:DropDownList ID="assigneddd" runat="server" DataSourceID="SqlContacts" DataTextField="name" DataValueField="userID">
                                </asp:DropDownList>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td style="width: 15%"><asp:Label ID="Label8" runat="server" CssClass="est_heading1" Text="Branch"></asp:Label></td>
                            <td style="width: 35%">
                                <asp:DropDownList ID="branchdd" runat="server" DataSourceID="SqlBranches" DataTextField="shipto" DataValueField="shipID">
                                </asp:DropDownList>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label36" runat="server" CssClass="est_heading1" Text="Username*"></asp:Label>
                            </td>
                        <td>
                            <asp:TextBox ID="c_usernametb" runat="server" CssClass="est_textbox1"></asp:TextBox>
                        </td>
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="c_usernametb" ErrorMessage="Required Field" ForeColor="Red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>
