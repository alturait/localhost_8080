<%@ Page Title="Locations" Language="VB" MasterPageFile="Admin.master" AutoEventWireup="false" CodeFile="Locations.aspx.vb" Inherits="Locations" %>
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlShipTos" DataKeyNames="shipID" GridLines="None" Width="100%" AllowSorting="True">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Location ID" InsertVisible="False" SortExpression="shipID">
                                        <ItemTemplate>
