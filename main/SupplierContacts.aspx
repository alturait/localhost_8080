<%@ Page Title="Supplier Contacts" Language="VB" MasterPageFile="~/main/Admin.master" AutoEventWireup="false" CodeFile="SupplierContacts.aspx.vb" Inherits="main_SupplierContacts" %>
        ...
        <tr>
            <td class="est_pagebody" style="vertical-align: top">
                <table style="width: 100%">
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlSupplierContacts" DataKeyNames="userID" GridLines="None" Width="100%" AllowSorting="True">
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:SqlDataSource ID="SqlSupplierContacts" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM t_user WHERE ([companyID] = @companyID) ORDER BY [name]">
                                <SelectParameters>
