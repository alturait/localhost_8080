<%@ Page Title="Check Out" Language="VB" MasterPageFile="~/main/Admin.master" AutoEventWireup="false" CodeFile="CheckOut.aspx.vb" Inherits="main_CheckOut" %>
        ...
        <tr>
            <td class="pagebody" style="vertical-align: top">
                <table style="width: 100%">
                        ...
                        <td style="vertical-align: top" rowspan="5">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="shiptotb" runat="server" Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="saddress1tb" runat="server" Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
                                        <asp:TextBox ID="saddress2tb" runat="server" Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
                                        <asp:TextBox ID="saddress3tb" runat="server" Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="scitytb" runat="server" Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="sstatetb" runat="server" Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:TextBox ID="szipcodetb" runat="server" Width="300px"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top">
                            <asp:DropDownList ID="shiptodd" runat="server" AppendDataBoundItems="True" AutoPostBack="True" DataSourceID="SqlShipTos" DataTextField="shipto" DataValueField="shipID">
                                <asp:ListItem Value="0">Select Ship To</asp:ListItem>
                            </asp:DropDownList>
                            </td>
                    </tr>
                    <tr>    
                        <td>
                            <asp:Label ID="Label32" runat="server" CssClass="est_heading1" Text="Ship Method"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>    
                        <td>
                            <asp:Label ID="Label10" runat="server" CssClass="est_heading1" Text="Ship Options"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>    
                        <td><asp:Label ID="Label11" runat="server" CssClass="est_heading1" Text="Contact"></asp:Label></td>
                        <td colspan="2">
                    ...
                    <tr>    
                        <td><asp:Label ID="Label1" runat="server" CssClass="est_heading1" Text="Email"></asp:Label></td>
                        <td colspan="2"><asp:TextBox ID="emailtb" runat="server" Width="300"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td colspan="3"></td>
                    </tr>
                                        ...
                                        <ItemTemplate>
                                            <table style="width: 100%">
                                                <tr>
                                                    ...
                                                    <td style="width: 10%; text-align: center;"><asp:Label ID="qtytb" runat="server" Text='<%# Bind("quantity") %>' Width="40"></asp:Label>
                                                    </td>
                    ...
                    <tr>
                        <td style="text-align: center" colspan="3">
                            <asp:Button ID="submitbtn" runat="server" Text="Place Order" CssClass="pushbutton1 gold" />
                            <asp:Button ID="returnbtn" runat="server" Text="Create Return" CssClass="pushbutton1 gold" />
