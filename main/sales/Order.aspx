<%@ Page Title="Order" Language="VB" MasterPageFile="Sales.master" AutoEventWireup="false" CodeFile="Order.aspx.vb" Inherits="EST_Order" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="est_pagetable">
            ...
            <td class="pagebody" style="vertical-align: top">
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>    
                            <asp:Label ID="Label52" runat="server" CssClass="heading1" Text="Kits"></asp:Label>    
                            </td>
                        <td>
                            <asp:LinkButton ID="kitIDlbl" runat="server" CssClass="est_label1"></asp:LinkButton>
                            </td>
                    </tr>
                    <tr>
                                        ...
                                        <HeaderTemplate>
                                            <table style="width: 100%">
                                                <tr>
                                                    ...
                                                    <td style="width: 10%; text-align: center;">Kit</td>
                                        ...
                                        <ItemTemplate>
                                            <table style="width: 100%">
                                                <tr>
                                                    ...
                                                    <td style="width: 10%; text-align: center;"><asp:Label ID="kitlbl" runat="server" Text='<%# appcode.GetOrderItemKitID(Eval("lineID"))%>'></asp:Label></td>
                                                    <td style="width: 10%; text-align: center;"><asp:Label ID="estdellbl" runat="server" Text='<%# appcode.GetEstimatedArrival(Eval("manufacturer"), Eval("partnumber"), Eval("quantity"))%>'></asp:Label></td>
        ...
        <tr>
            <td style="vertical-align: top">
                <asp:SqlDataSource ID="SqlLines" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT *,quantity * price as extended, quantity * cost as extendedcost FROM [v_order_lines] WHERE ([orderID] = @orderID) ORDER BY [lineID]">
                    <SelectParameters>
