<%@ Page Title="Product Catalog" Language="VB" MasterPageFile="Sales.master" AutoEventWireup="false" CodeFile="VCatalog.aspx.vb" Inherits="main_VCatalog" %>
                                                        ...
                                                        <HeaderTemplate>
                                                            <table style="width: 100%">
                                                                <tr>
                                                                    ...
                                                                    <td style="vertical-align: top; text-align: right; width: 20%"><asp:Label ID="Label4" runat="server" Text="Your Price" CssClass="est_heading1"></asp:Label></td>
                                                        ...
                                                        <ItemTemplate>
                                                            <table style="width: 100%">
                                                                <tr>
                                                                    ...
                                                                    <td style="vertical-align: middle; text-align: left; width: 15%"><asp:Label ID="parnumberlbl" runat="server" Text='<%# Eval("partnumber")%>' Font-Size="10pt"></asp:Label></td>
                                                                    <td style="vertical-align: middle; text-align: left; width: 45%"><asp:Label ID="Label13" runat="server" Text='<%# Eval("item")%>' Font-Size="10pt"></asp:Label></td>
                                                                    <td style="vertical-align: middle; text-align: right; width: 20%"><asp:Label ID="pricelbl" runat="server" Text='<%# FormatCurrency(appcode.GetCompanyPrice(Session("selected_companyID"), Eval("manufacturer"), Eval("partnumber")), 2)%>' Font-Size="10pt"></asp:Label> <asp:Label ID="uomlbl" runat="server" Text='<%# Eval("uom")%>'></asp:Label></td>
                                                                    <td style="vertical-align: middle; text-align: right; width: 10%">
                                                                        <asp:Button ID="detailbtn" runat="server" Text="More" CommandName="Detail" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" CssClass="pushbutton1 gold" />
                                                                        <asp:Button ID="editbtn" runat="server" Text="Edit" CommandName="Edit" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" CssClass="pushbutton1 gold" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </ItemTemplate>
