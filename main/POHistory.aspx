<%@ Page Title="PO History" Language="VB" MasterPageFile="Admin.master" AutoEventWireup="false" CodeFile="POHistory.aspx.vb" Inherits="EST_POHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlPOs" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [t_po] WHERE complete=@complete and MONTH(date_submitted)=@month and YEAR(date_submitted)=@year ORDER BY supplier,poID">
        <SelectParameters>
