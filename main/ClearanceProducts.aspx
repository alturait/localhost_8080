<%@ Page Title="Clearance Products" Language="VB" MasterPageFile="Admin.master" AutoEventWireup="false" CodeFile="ClearanceProducts.aspx.vb" Inherits="main_ClearanceProducts" %>
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <asp:SqlDataSource ID="SqlFeaturedProducts" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [t_product] WHERE ([clearance] = @clearance) order by manufacturer, partnumber">
                                <SelectParameters>
                                    <asp:Parameter DefaultValue="True" Name="clearance" Type="Boolean" />
                                </SelectParameters>
                            </asp:SqlDataSource>
