<%@ Page Title="Packing Slip" Language="VB" MasterPageFile="Admin.master" AutoEventWireup="false" CodeFile="Invoice.aspx.vb" Inherits="EST_Invoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="est_pagetable">
                ...
                <table style="width: 100%">
                    <tr>
                        <td colspan="2">
                            ...
                            <asp:LinkButton ID="qbobtn" runat="server" Text="Enter in QBO" OnClientClick="return confirm('Is this invoice entered in QBO?');" Width="119px" />
                    ...
                    <tr>
                        <td style="width: 15%">
                            <asp:Label ID="Label8" runat="server" CssClass="heading1" Text="Invoiced By"></asp:Label>
                        </td>
                        <td style="width: 35%">
                            <asp:Label ID="invoice_userIDlbl" runat="server"></asp:Label>
                        </td>
                        <td style="width: 15%"><asp:Label ID="Label9" runat="server" CssClass="heading1" Text="Shipped By"></asp:Label></td>
                        <td style="width: 35%"><asp:Label ID="ship_userIDlbl" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td style="width: 15%">
                        ...
                        <td style="width: 15%"><asp:Label ID="Label10" runat="server" CssClass="heading1" Text="Picked By"></asp:Label></td>
                        <td style="width: 35%"><asp:Label ID="pick_userIDlbl" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td style="width: 15%">
                    ...
                    <tr>
                        ...
                        <td style="width: 15%">
                            <asp:Label ID="Label57" runat="server" CssClass="heading1" Text="Assets"></asp:Label>
                        </td>
                        <td style="width: 35%">
                            <asp:Label ID="assetIDlbl" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 15%">
                    ...
                    <tr>
                        <td style="width: 15%">
                            <asp:Label ID="Label11" runat="server" CssClass="heading1" Text="Order ID"></asp:Label>
                        </td>
                        <td style="width: 35%">
                            <asp:LinkButton ID="orderbtn" runat="server"><asp:Label ID="orderIDlbl" runat="server" CssClass="heading1" Text="OrderID"></asp:Label></asp:LinkButton>
                            <asp:LinkButton ID="pickticketbtn" runat="server">Pick Ticket</asp:LinkButton>
                        </td>
                        <td style="width: 15%">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="purchaseorderlbl" runat="server" CssClass="heading1" Text="Purchase Order"></asp:Label>
                        </td>
                        <td>
                            <asp:Panel ID="Panel1" runat="server">
                                <asp:TextBox ID="potb" runat="server" CssClass="est_label1"></asp:TextBox>&nbsp;&nbsp;&nbsp;
                                <asp:Button ID="savebtn" runat="server" Text="Enter PO" />
                            </asp:Panel>
                            <asp:Panel ID="Panel2" runat="server">
                                <asp:Label ID="polbl" runat="server" CssClass="heading1"></asp:Label>
                            </asp:Panel>
                        </td>
                        <td>
                                        ...
                                        <FooterTemplate>
                                            <table style="width: 100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 10%; text-align: left;"></td>
                                                    <td style="width: 20%; text-align: left;"></td>
                                                    <td style="width: 10%; text-align: left;"><asp:Label ID="Label1" runat="server" Text="Surcharge" Font-Bold="True"></asp:Label></td>
        ...
        <tr>
            <td>
                <asp:SqlDataSource ID="SqlLines" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT *,ship_qty * price as extended FROM [v_shipment_lines] WHERE ([shipmentID] = @shipmentID) AND ship_qty>0 ORDER BY [lineID]">
                    <SelectParameters>
