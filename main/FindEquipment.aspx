<%@ Page Title="Add Equipment" Language="VB" MasterPageFile="Admin.master" AutoEventWireup="false" CodeFile="FindEquipment.aspx.vb" Inherits="main_FindEquipment" %>
                        ...
                        <td style="text-align: center; width: 40%">
                            <asp:Panel ID="Panel1" runat="server" DefaultButton="esearchbtn">
                                <p style="text-align: center">
                                    ...
                                    <asp:Button ID="esearchbtn" runat="server" Text="Search" CssClass="pushbutton1 gold" />
                                    <asp:Button ID="newequipbtn" runat="server" CssClass="pushbutton1 gold" Text="New Profile" ToolTip="Save this profile and return to the asset list." />
                                </p>
                            </asp:Panel>                            
                        </td>
                        <td style="text-align: right; width: 30%">
                            <asp:Label ID="searchlbl" runat="server" Text="Search For  " Font-Bold="True" Font-Size="Medium"></asp:Label>
