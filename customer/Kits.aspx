<%@ Page Title="Kits" Language="VB" MasterPageFile="CustomerMaster.master" AutoEventWireup="false" CodeFile="Kits.aspx.vb" Inherits="customer_Kits" %>
                                            ...
                                            <table style="width: 100%">
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: top; text-align: right; width: 10%">
                                                        <asp:Label ID="Label7" runat="server" Text='<%# FormatCurrency(appcode.GetKitCost(Eval("serviceprofileID")), 2)%>'></asp:Label>
                                                    </td>
                                                    <td style="width: 10%;"></td>
