...
Partial Class customer_CopyEquipment
        ...
        If Not IsPostBack Then
            ...
            If Session("equipmentID").ToString <> "" Then
                ...
                If reader.Read Then
                    ...
                    iroottb.Text = reader.Item("interval_root").ToString
    ...
    Protected Sub savebtn_Click(sender As Object, e As EventArgs) Handles savebtn.Click
        If equipmentnumtb.Text <> "" Then
            ...
            For Each row In GridView1.Rows
                ...
                Dim desclbl As Label = row.FindControl("desclbl")
                ...
                Dim partID As Integer = appcode.InsertPart(equipmentID, part_typelbl.Text, manufacturerlbl.Text, partnumberlbl.Text, desclbl.Text, alt_manufacturerlbl.Text, alt_partnumberlbl.Text, oem_manufacturerlbl.Text, oem_partnumberlbl.Text, quantitylbl.Text, uomlbl.Text, pricelbl.Text, "")
            Next
