<%@ Page Title="Complete Order" Language="VB" MasterPageFile="~/customer/CustomerMaster.master" AutoEventWireup="false" CodeFile="CompleteOrder.aspx.vb" Inherits="customer_CompleteOrder" %>
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        <td style="vertical-align: top">
                            <asp:Label ID="Label35" runat="server" CssClass="heading1" Text="Confirmed"></asp:Label>
                        </td>
                        <td style="vertical-align: top">
                            <asp:Label ID="confirmlbl" runat="server" CssClass="est_label1"></asp:Label>
                        </td>
                        <td style="vertical-align: top">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <table style="width: 100%">
                                                <tr>
                                                    <td style="width: 50%; text-align: left;">Part Number</td>
