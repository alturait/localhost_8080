<%@ Page Title="Edit Equipment Profile" Language="VB" MasterPageFile="~/customer/CustomerMaster.master" AutoEventWireup="false" CodeFile="EditEquipment.aspx.vb" Inherits="customer_EditEquipment" %>
            ...
            <td class="pagebody" style="vertical-align: top">
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="rootintervaltb" runat="server" CssClass="est_textbox2"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="vertical-align: top">
