<%@ Page Title="Copy Equipment" Language="VB" MasterPageFile="~/customer/CustomerMaster.master" AutoEventWireup="false" CodeFile="CopyEquipment.aspx.vb" Inherits="customer_CopyEquipment" %>
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            &nbsp;</td>
                        <td>    
                            <asp:Label ID="Label42" runat="server" CssClass="heading1" Text="Interval Root"></asp:Label>
                        </td>
                        <td>
                            <asp:Textbox ID="iroottb" runat="server" CssClass="est_textbox2"></asp:Textbox>
                        </td>
                    </tr>
                    <tr>
                                        ...
                                        <ItemTemplate>
                                            <table style="width: 100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4">
                                                        <asp:Label ID="desclbl"  runat="server" Text='<%# Eval("description").ToString%>'></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
