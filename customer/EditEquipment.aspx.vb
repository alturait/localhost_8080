...
Partial Class customer_EditEquipment
        ...
        If Not IsPostBack Then
            ...
            If Session("equipmentID").ToString <> "" Then
                ...
                If reader.Read Then
                    ...
                    rootintervaltb.Text = reader.Item("interval_root")
