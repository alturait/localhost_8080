<%@ Page Title="Catalog" Language="VB" MasterPageFile="CustomerMaster.master" AutoEventWireup="false" CodeFile="Catalog.aspx.vb" Inherits="customer_Catalog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                            ...
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                        <asp:LinkButton ID="addselectedbtn" runat="server">Add Selected</asp:LinkButton>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="100%">
                                            ...
                                            <ItemTemplate>
                                                <table style="width: 100%">
                                                    <tr>
                                                        <td style="vertical-align: middle; text-align: left; width: 5%;" rowspan="2"><img alt="" src='../Images/Catalog/<%# GetPicture(Eval("partnumber"))%>.jpg' width="50" height="50" /></td>
                                                        <td style="vertical-align: middle; text-align: left; width: 55%;"><asp:Label ID="manufacturerlbl" runat="server" Text='<%# Eval("manufacturer")%>'>&nbsp;</asp:Label><asp:Label ID="partnumberlbl" runat="server" Text='<%# Eval("partnumber")%>'></asp:Label></td>
                                                        ...
                                                        <td style="vertical-align: middle; text-align: right;"><asp:Button ID="addbtn" runat="server" Text="Add To Cart" CommandName="addtocart" CommandArgument="<%# CType(Container, GridViewRow).RowIndex %>" CssClass="pushbutton1 gold" /></td>
                                                    </tr>
                                                    <tr>
    ...
    <asp:SqlDataSource ID="SqlFeatureProducts" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT TOP (2) * FROM v_catalog WHERE parentID=@parentID and featured=@featured ORDER BY NEWID()">
        <SelectParameters>
            <asp:QueryStringParameter Name="parentID" QueryStringField="categoryID" />
