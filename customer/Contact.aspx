<%@ Page Title="User" Language="VB" MasterPageFile="~/customer/CustomerMaster.master" AutoEventWireup="false" CodeFile="Contact.aspx.vb" Inherits="customer_Contact" %>
        ...
        <tr>
            <td class="pagebody" style="vertical-align: top">
                <table style="width: 100%">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label1" runat="server" CssClass="est_heading1" Text="Admin"></asp:Label>
                        </td>
                        <td>
                            <asp:CheckBox ID="c_admincb" runat="server" />
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label37" runat="server" CssClass="est_heading1" Text="Username*"></asp:Label>
                            </td>
                        <td>
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:SqlDataSource ID="SqlBranches" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT [shipID], [shipto] FROM [t_ship] WHERE ([companyID] = @companyID) ORDER BY [shipto]">
                                <SelectParameters>
                                    <asp:Parameter DefaultValue="11" Name="companyID" Type="Int32" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </td>
                    </tr>
